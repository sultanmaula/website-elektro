...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <a href="{{ route('add-users') }}" class="btn btn-sm btn-info m-2"><i class="fa fa-plus mr-2"></i> Tambah User</a>
      <table class="table">
        ...
        <tbody>
          @foreach ($users as $d)
            <tr>
              ...
              @can('edit user')
              <td>
                <a href="{{route('edit-users', $d->id)}}" type="button" class="btn btn-success btn-xs"><i class="fa fa-pen"></i></a>
                <a class="btn btn-danger btn-xs" data-target="#modal" data-record-id="{{$d->id}}" data-toggle="modal"><i class="fa fa-trash-alt"></i></a>
              </td>
              @endcan
            </tr>
          @endforeach
  ...
  <div class="modal-dialog modal-md">
      <div class="modal-content" style="min-height: 220px;">
          ...
          <div class="modal-body">
              <h6>Yakin menghapus user ini?</h6>
...
<script>
  ...
  $('#modal').on('click', '.btn-delete', function(e) {
      ...
      var route = "{{route('destroy-users', ":id")}}";
