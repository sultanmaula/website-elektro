            ...
            <form action="{{route('update-roles', $role->id)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="permission[]" multiple>
                            ...
                            @if (in_array($permission->id, $role->permission))
                ...
                <div class="form-group">
                  ...
                  <input type="checkbox" name="active" {{ $role->active == 1 ? 'checked' : '' }} data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" data-size="xs">
                </div>
              </div>
              <!-- /.card-body -->
