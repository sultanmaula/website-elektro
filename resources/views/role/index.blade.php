...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <a href="{{ route('add-roles') }}" class="btn btn-sm btn-info m-2"><i class="fa fa-plus mr-2"></i> Tambah Role</a>
      <table class="table">
        ...
        <tbody>
          @foreach ($roles as $role)
            <tr>
              ...
              <td>{{$role->name}}</td>
              <td>
                <a href="{{route('edit-roles', $role->id)}}" type="button" class="btn btn-success btn-xs"><i class="fa fa-pen"></i></a>
                <a class="btn btn-danger btn-xs" data-target="#modal" data-record-id="{{$role->id}}" data-toggle="modal"><i class="fa fa-trash-alt"></i></a>
              </td>
            </tr>
          @endforeach
        </tbody>
  ...
  <div class="modal-dialog modal-md">
      <div class="modal-content" style="min-height: 220px;">
          ...
          <div class="modal-body">
              <h6>Yakin menghapus role ini?</h6>
...
<script>
  ...
  $('#modal').on('click', '.btn-delete', function(e) {
      ...
      var route = "{{route('destroy-roles', ":id")}}";
